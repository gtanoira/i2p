...
exports.CreateCentroCostoDto = void 0;
...
], CreateCentroCostoDto.prototype, "sapId", void 0);
__decorate([
    class_validator_1.IsString(),
    class_validator_1.IsNotEmpty({
    ...
    __metadata("design:type", String)
], CreateCentroCostoDto.prototype, "name", void 0);
exports.CreateCentroCostoDto = CreateCentroCostoDto;
//# sourceMappingURL=centro-costo.dto.js.map